...
export class AuthService {
  ...
  // autentikaatiopalvelun osoite, Когда серверную часть прикрепили к heruku
  //private apiUrl = 'https://warm-lowlands-87442.herokuapp.com/users/login'; // autentikaatiopalvelun osoite
  public token: string;
